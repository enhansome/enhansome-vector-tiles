...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,007 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,393 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-01 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,506 | 🐛 386 | 🌐 TypeScript | 📅 2026-09-01 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-01 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 131 | 🌐 C++ | 📅 2026-08-29 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,888 | 🐛 65 | 🌐 Rust | 📅 2026-09-01 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-09-01 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 131 | 🌐 C++ | 📅 2026-08-29 to generating vector tiles

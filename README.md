...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,391 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-08-28 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,490 | 🐛 385 | 🌐 TypeScript | 📅 2026-08-29 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-08-30 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,615 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-28 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,159 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,886 | 🐛 129 | 🌐 C++ | 📅 2026-08-29 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,588 | 🐛 164 | 🌐 C++ | 📅 2026-08-14 - Build vector tilesets from large collections of GeoJSON features.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,883 | 🐛 72 | 🌐 Rust | 📅 2026-08-30 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,891 | 🐛 268 | 🌐 JavaScript | 📅 2026-08-30 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [pg\_tileserv](https://github.com/CrunchyData/pg_tileserv) ⭐ 1,059 | 🐛 42 | 🌐 Go | 📅 2025-12-11 - A very thin PostGIS-only tile server in Go. Takes in HTTP tile requests, executes SQL, returns MVT tiles.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-30 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,886 | 🐛 129 | 🌐 C++ | 📅 2026-08-29 to generating vector tiles

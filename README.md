...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,389 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-08-25 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,433 | 🐛 383 | 🌐 TypeScript | 📅 2026-08-25 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,223 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 88 | 🐛 2 | 🌐 Swift | 📅 2026-08-25 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,611 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-25 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,154 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,587 | 🐛 164 | 🌐 C++ | 📅 2026-08-14 - Build vector tilesets from large collections of GeoJSON features.
...
* [map-gl-offline](https://github.com/muimsd/map-gl-offline) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 - A TypeScript package for MapLibre GL JS and Mapbox GL JS to enable offline tiles.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,861 | 🐛 74 | 🌐 Rust | 📅 2026-08-25 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,885 | 🐛 274 | 🌐 JavaScript | 📅 2026-08-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - One platform for publishing cartographic resources from PostGIS (developed in Rust).

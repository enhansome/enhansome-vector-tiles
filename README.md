...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,382 | 🐛 1,456 | 🌐 TypeScript | 📅 2026-08-18 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,375 | 🐛 393 | 🌐 TypeScript | 📅 2026-08-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 88 | 🐛 2 | 🌐 Swift | 📅 2026-08-18 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,605 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-18 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,144 | 🐛 113 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - One platform for publishing cartographic resources from PostGIS (developed in Rust).

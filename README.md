...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,003 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,123 | 🐛 18 | 🌐 Go | 📅 2026-03-30 - A Go geometry library with mvt <-> geojson support.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,373 | 🐛 1,453 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,326 | 🐛 382 | 🌐 TypeScript | 📅 2026-08-12 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
* [Mapzen Tangram](https://github.com/tangrams/tangram) ⭐ 2,332 | 🐛 66 | 🌐 JavaScript | 📅 2026-02-08 - JavaScript library for rendering 2D & 3D maps live in a web browser with WebGL, supports MVT, GeoJSON, TopoJSON
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,213 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,263 | 🐛 289 | 🌐 JavaScript | 📅 2026-08-11 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
- [mapbox-gl-leaflet](https://github.com/mapbox/mapbox-gl-leaflet) ⭐ 545 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-17 - Create Mapbox GL layers in Leaflet
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 88 | 🐛 3 | 🌐 Swift | 📅 2026-08-12 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
- [esri-gl](https://github.com/muimsd/esri-gl) ⭐ 13 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-16 - A module for using Esri services in Mapbox GL JS or MapLibre GL JS, an alternative to esri-leaflet for WebGL.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,604 | 🐛 102 | 🌐 TypeScript | 📅 2026-08-12 - A visual style editor for the Mapbox GL style specification.
...
* [Fresco](https://github.com/go-spatial/fresco) ⭐ 257 | 🐛 61 | 🌐 JavaScript | 📅 2023-03-01 - is an open source Mapbox Vector Tile Style editor.
...
* [Styl](https://github.com/navidnabavi/styl) ⭐ 38 | 🐛 7 | 🌐 Rust | 📅 2026-07-25 - A fast, opinionated linter, validator, and formatter for Mapbox GL and MapLibre GL style JSON files, written in Rust
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,135 | 🐛 111 | 🌐 Java | 📅 2026-08-11 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,878 | 🐛 139 | 🌐 C++ | 📅 2026-07-04 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,582 | 🐛 164 | 🌐 C++ | 📅 2026-08-12 - Build vector tilesets from large collections of GeoJSON features.
...
* [tilefeed](https://github.com/muimsd/tilefeed) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-07-28 - PostGIS vector tile pipeline that generates MBTiles via Tippecanoe with incremental updates via PostgreSQL LISTEN/NOTIFY.
* [vt2geojson](https://github.com/wangyoucao577/vt2geojson) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2023-02-20 Command line tool to convert Vector Tiles to GeoJSON (written in `Go` language based on the awesome [orb](https://github.com/paulmach/orb) ⭐ 1,123 | 🐛 18 | 🌐 Go | 📅 2026-03-30 package).
...
* [gl-draw](https://github.com/mapbox/gl-draw) ⭐ 1,084 | 🐛 251 | 🌐 JavaScript | 📅 2026-08-10 - Adds support for drawing and editing features on Mapbox GL JS maps
* [map-gl-offline](https://github.com/muimsd/map-gl-offline) ⭐ 20 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-15 - A TypeScript package for MapLibre GL JS and Mapbox GL JS to enable offline tiles.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,823 | 🐛 79 | 🌐 Rust | 📅 2026-08-11 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,878 | 🐛 270 | 🌐 JavaScript | 📅 2026-08-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,498 | 🐛 182 | 🌐 Go | 📅 2026-08-10 - is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [BBOX](https://github.com/bbox-services/bbox) ⭐ 165 | 🐛 21 | 🌐 Rust | 📅 2025-10-11 - An open source server to provide geodata as OGC API features, maps, tiles and more
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-09 - One platform for publishing cartographic resources from PostGIS (developed in Rust).
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-10 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [vtzero](https://github.com/mapbox/vtzero) ⭐ 105 | 🐛 1 | 🌐 C++ | 📅 2026-06-30 - minimalist vector tile decoder and encoder in C++
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,878 | 🐛 139 | 🌐 C++ | 📅 2026-07-04 to generating vector tiles

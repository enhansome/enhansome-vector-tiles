...
* [vector-tile-js](https://github.com/mapbox/vector-tile-js) ⭐ 403 | 🐛 8 | 🌐 JavaScript | 📅 2026-06-24 - Parses vector tiles with JavaScript.
...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,043 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 to convert GeoJSON into vector tiles.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,396 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-03 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,528 | 🐛 387 | 🌐 TypeScript | 📅 2026-09-03 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,230 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,266 | 🐛 290 | 🌐 JavaScript | 📅 2026-09-03 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-03 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,618 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-03 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,163 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,889 | 🐛 134 | 🌐 C++ | 📅 2026-09-03 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,043 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03)
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,888 | 🐛 53 | 🌐 Rust | 📅 2026-09-03 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
...
* [pg\_tileserv](https://github.com/CrunchyData/pg_tileserv) ⭐ 1,060 | 🐛 42 | 🌐 Go | 📅 2025-12-11 - A very thin PostGIS-only tile server in Go. Takes in HTTP tile requests, executes SQL, returns MVT tiles.
* [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 790 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - A simple Go-based server for map tiles stored in mbtiles format.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,889 | 🐛 134 | 🌐 C++ | 📅 2026-09-03 to generating vector tiles

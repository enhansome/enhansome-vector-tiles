...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,399 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-07 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,564 | 🐛 285 | 🌐 TypeScript | 📅 2026-09-07 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,267 | 🐛 293 | 🌐 JavaScript | 📅 2026-09-07 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,627 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-07 - A visual style editor for the Mapbox GL style specification.
...
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,595 | 🐛 165 | 🌐 C++ | 📅 2026-08-31 - Build vector tilesets from large collections of GeoJSON features.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,896 | 🐛 51 | 🌐 Rust | 📅 2026-09-07 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,894 | 🐛 272 | 🌐 JavaScript | 📅 2026-09-03 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.

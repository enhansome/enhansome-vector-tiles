...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,011 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [node-mapnik](https://github.com/mapnik/node-mapnik) ⭐ 546 | 🐛 104 | 🌐 C++ | 📅 2026-08-30 - Node.js API for vector tiles which depends on `mapnik-vector-tile`
...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,079 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 to convert GeoJSON into vector tiles.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,414 | 🐛 1,457 | 🌐 TypeScript | 📅 2026-09-21 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,714 | 🐛 286 | 🌐 TypeScript | 📅 2026-09-21 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,239 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,638 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - A visual style editor for the Mapbox GL style specification.
...
* [Styl](https://github.com/navidnabavi/styl) ⭐ 39 | 🐛 1 | 🌐 Rust | 📅 2026-09-20 - A fast, opinionated linter, validator, and formatter for Mapbox GL and MapLibre GL style JSON files, written in Rust
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,185 | 🐛 110 | 🌐 Java | 📅 2026-09-21 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,606 | 🐛 165 | 🌐 C++ | 📅 2026-08-31 - Build vector tilesets from large collections of GeoJSON features.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,079 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05)
...
* [gl-draw](https://github.com/mapbox/gl-draw) ⭐ 1,087 | 🐛 243 | 🌐 JavaScript | 📅 2026-09-21 - Adds support for drawing and editing features on Mapbox GL JS maps
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,934 | 🐛 46 | 🌐 Rust | 📅 2026-09-21 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,904 | 🐛 271 | 🌐 JavaScript | 📅 2026-09-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 49 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - One platform for publishing cartographic resources from PostGIS (developed in Rust).
...
* [Maptoolkit.org](https://github.com/maptoolkit/maptoolkit.org) ⭐ 32 | 🐛 0 | 📅 2026-09-18 - free REST API serving MVT vector tiles

...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,462 | 🐛 383 | 🌐 TypeScript | 📅 2026-08-27 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,227 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,613 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-26 - A visual style editor for the Mapbox GL style specification.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,874 | 🐛 73 | 🌐 Rust | 📅 2026-08-26 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,888 | 🐛 274 | 🌐 JavaScript | 📅 2026-08-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-23 - A thin map tile proxy with in-memory caching and a slim authentication backend.

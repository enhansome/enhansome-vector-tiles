...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,064 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 to convert GeoJSON into vector tiles.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,405 | 🐛 1,456 | 🌐 TypeScript | 📅 2026-09-10 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,604 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-10 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-10 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,170 | 🐛 111 | 🌐 Java | 📅 2026-09-10 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,890 | 🐛 135 | 🌐 C++ | 📅 2026-09-04 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,064 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05)
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,908 | 🐛 50 | 🌐 Rust | 📅 2026-09-10 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,894 | 🐛 271 | 🌐 JavaScript | 📅 2026-09-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [tessera](https://github.com/mojodna/tessera) ⭐ 325 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-10 - Supports serving and rendering vector tiles. Uses the same core libraries as Mapbox Studio.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - One platform for publishing cartographic resources from PostGIS (developed in Rust).
...
* [Maptoolkit.org](https://github.com/maptoolkit/maptoolkit.org) ⭐ 29 | 🐛 0 | 📅 2026-09-10 - free REST API serving MVT vector tiles
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,890 | 🐛 135 | 🌐 C++ | 📅 2026-09-04 to generating vector tiles

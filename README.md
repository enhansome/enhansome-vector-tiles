...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,008 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,128 | 🐛 19 | 🌐 Go | 📅 2026-03-30 - A Go geometry library with mvt <-> geojson support.
...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,042 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-02 to convert GeoJSON into vector tiles.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,395 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-02 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,520 | 🐛 386 | 🌐 TypeScript | 📅 2026-09-02 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,266 | 🐛 288 | 🌐 JavaScript | 📅 2026-09-01 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-02 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,618 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-02 - A visual style editor for the Mapbox GL style specification.
...
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 133 | 🌐 C++ | 📅 2026-08-29 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,042 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-02)
...
* [vt2geojson](https://github.com/wangyoucao577/vt2geojson) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2023-02-20 Command line tool to convert Vector Tiles to GeoJSON (written in `Go` language based on the awesome [orb](https://github.com/paulmach/orb) ⭐ 1,128 | 🐛 19 | 🌐 Go | 📅 2026-03-30 package).
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,887 | 🐛 66 | 🌐 Rust | 📅 2026-09-02 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,894 | 🐛 269 | 🌐 JavaScript | 📅 2026-08-31 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-09-02 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 133 | 🌐 C++ | 📅 2026-08-29 to generating vector tiles

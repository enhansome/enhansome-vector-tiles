...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,391 | 🐛 1,461 | 🌐 TypeScript | 📅 2026-08-26 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,469 | 🐛 382 | 🌐 TypeScript | 📅 2026-08-27 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-08-27 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,613 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-27 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,157 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,884 | 🐛 139 | 🌐 C++ | 📅 2026-08-27 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,874 | 🐛 70 | 🌐 Rust | 📅 2026-08-27 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,888 | 🐛 275 | 🌐 JavaScript | 📅 2026-08-10 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-27 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,884 | 🐛 139 | 🌐 C++ | 📅 2026-08-27 to generating vector tiles

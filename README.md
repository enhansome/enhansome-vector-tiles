...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,005 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,127 | 🐛 19 | 🌐 Go | 📅 2026-03-30 - A Go geometry library with mvt <-> geojson support.
...
* [node-mapnik](https://github.com/mapnik/node-mapnik) ⭐ 545 | 🐛 104 | 🌐 C++ | 📅 2026-08-28 - Node.js API for vector tiles which depends on `mapnik-vector-tile`
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,483 | 🐛 385 | 🌐 TypeScript | 📅 2026-08-29 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-08-29 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,614 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-28 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,158 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,885 | 🐛 129 | 🌐 C++ | 📅 2026-08-29 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
...
* [vt2geojson](https://github.com/wangyoucao577/vt2geojson) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2023-02-20 Command line tool to convert Vector Tiles to GeoJSON (written in `Go` language based on the awesome [orb](https://github.com/paulmach/orb) ⭐ 1,127 | 🐛 19 | 🌐 Go | 📅 2026-03-30 package).
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,881 | 🐛 70 | 🌐 Rust | 📅 2026-08-29 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,891 | 🐛 269 | 🌐 JavaScript | 📅 2026-08-29 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,502 | 🐛 181 | 🌐 Go | 📅 2026-08-20 - is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-29 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,885 | 🐛 129 | 🌐 C++ | 📅 2026-08-29 to generating vector tiles

...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,380 | 🐛 1,456 | 🌐 TypeScript | 📅 2026-08-17 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,364 | 🐛 389 | 🌐 TypeScript | 📅 2026-08-17 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,220 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 88 | 🐛 3 | 🌐 Swift | 📅 2026-08-17 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,604 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-17 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,142 | 🐛 112 | 🌐 Java | 📅 2026-08-13 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [gl-draw](https://github.com/mapbox/gl-draw) ⭐ 1,084 | 🐛 242 | 🌐 JavaScript | 📅 2026-08-17 - Adds support for drawing and editing features on Mapbox GL JS maps
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,834 | 🐛 81 | 🌐 Rust | 📅 2026-08-15 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-17 - One platform for publishing cartographic resources from PostGIS (developed in Rust).
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,882 | 🐛 138 | 🌐 C++ | 📅 2026-07-04 to generating vector tiles

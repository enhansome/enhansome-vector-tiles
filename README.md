...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,010 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
data into vector tiles that can be rendered dynamically.

## Parsers & Generators

* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,050 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - Slice GeoJSON into vector tiles on the fly in the browser.
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 19 | 🌐 Go | 📅 2026-03-30 - A Go geometry library with mvt <-> geojson support.
...
* [node-mapnik](https://github.com/mapnik/node-mapnik) ⭐ 545 | 🐛 104 | 🌐 C++ | 📅 2026-08-30 - Node.js API for vector tiles which depends on `mapnik-vector-tile`
* [vector-tile-js](https://github.com/mapbox/vector-tile-js) ⭐ 404 | 🐛 8 | 🌐 JavaScript | 📅 2026-06-24 - Parses vector tiles with JavaScript.
...
* [java-vector-tile](https://github.com/ElectronicChartCentre/java-vector-tile) ⭐ 210 | 🐛 0 | 🌐 Java | 📅 2025-01-15 - A java encoder and decoder for vector tiles.
...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,050 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 to convert GeoJSON into vector tiles.
...
* [vt2pbf](https://github.com/DenysMoskalenko/vt2pbf) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2026-03-02 - Python port of [vt-pbf](https://github.com/mapbox/vt-pbf) ⭐ 206 | 🐛 10 | 🌐 JavaScript | 📅 2026-06-17 encode vector tiles into pbf.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,404 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-09 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,584 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-09 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,232 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,268 | 🐛 294 | 🌐 JavaScript | 📅 2026-09-07 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-09 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
- [esri-gl](https://github.com/muimsd/esri-gl) ⭐ 13 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - A module for using Esri services in Mapbox GL JS or MapLibre GL JS, an alternative to esri-leaflet for WebGL.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,627 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-09 - A visual style editor for the Mapbox GL style specification.
...
* [Styl](https://github.com/navidnabavi/styl) ⭐ 38 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 - A fast, opinionated linter, validator, and formatter for Mapbox GL and MapLibre GL style JSON files, written in Rust
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,169 | 🐛 114 | 🌐 Java | 📅 2026-09-07 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,889 | 🐛 134 | 🌐 C++ | 📅 2026-09-04 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,597 | 🐛 165 | 🌐 C++ | 📅 2026-08-31 - Build vector tilesets from large collections of GeoJSON features.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,050 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05)
...
* [tilefeed](https://github.com/muimsd/tilefeed) ⭐ 7 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - PostGIS vector tile pipeline that generates MBTiles via Tippecanoe with incremental updates via PostgreSQL LISTEN/NOTIFY.
* [vt2geojson](https://github.com/wangyoucao577/vt2geojson) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2023-02-20 Command line tool to convert Vector Tiles to GeoJSON (written in `Go` language based on the awesome [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 19 | 🌐 Go | 📅 2026-03-30 package).
...
* [gl-draw](https://github.com/mapbox/gl-draw) ⭐ 1,083 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Adds support for drawing and editing features on Mapbox GL JS maps
* [map-gl-offline](https://github.com/muimsd/map-gl-offline) ⭐ 24 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - A TypeScript package for MapLibre GL JS and Mapbox GL JS to enable offline tiles.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,902 | 🐛 50 | 🌐 Rust | 📅 2026-09-09 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,894 | 🐛 271 | 🌐 JavaScript | 📅 2026-09-09 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,503 | 🐛 182 | 🌐 Go | 📅 2026-09-09 - is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
* [pg\_tileserv](https://github.com/CrunchyData/pg_tileserv) ⭐ 1,061 | 🐛 42 | 🌐 Go | 📅 2025-12-11 - A very thin PostGIS-only tile server in Go. Takes in HTTP tile requests, executes SQL, returns MVT tiles.
* [mbtileserver](https://github.com/consbio/mbtileserver) ⭐ 791 | 🐛 23 | 🌐 Go | 📅 2025-05-21 - A simple Go-based server for map tiles stored in mbtiles format.
...
* [tessera](https://github.com/mojodna/tessera) ⭐ 325 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-03 - Supports serving and rendering vector tiles. Uses the same core libraries as Mapbox Studio.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - One platform for publishing cartographic resources from PostGIS (developed in Rust).
...
* [Maptoolkit.org](https://github.com/maptoolkit/maptoolkit.org) ⭐ 29 | 🐛 0 | 📅 2026-09-07 - free REST API serving MVT vector tiles
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 13 | 🌐 Go | 📅 2026-09-03 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [vt-pbf](https://github.com/anandthakker/vt-pbf) ⭐ 206 | 🐛 10 | 🌐 JavaScript | 📅 2026-06-17 serialize JavaScript objects representing vector tiles into binary Protocol Buffer encodings of vector tiles
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,889 | 🐛 134 | 🌐 C++ | 📅 2026-09-04 to generating vector tiles

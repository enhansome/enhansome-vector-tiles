...
* [geojson2vt](https://github.com/geometalab/geojson2vt) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2021-04-20 - Python port of [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,045 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 to convert GeoJSON into vector tiles.
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,395 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-04 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,535 | 🐛 390 | 🌐 TypeScript | 📅 2026-09-04 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,231 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-09-04 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,619 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-04 - A visual style editor for the Mapbox GL style specification.
...
* [Styl](https://github.com/navidnabavi/styl) ⭐ 38 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 - A fast, opinionated linter, validator, and formatter for Mapbox GL and MapLibre GL style JSON files, written in Rust
...
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,590 | 🐛 165 | 🌐 C++ | 📅 2026-08-31 - Build vector tilesets from large collections of GeoJSON features.
...
* [geojson2mvt](https://github.com/NYCPlanning/geojson2mvt) ⚠️ Archived - npm package for building a static vector tile tree for given xyz bounds from a geojson file (uses [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,045 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03)
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,889 | 🐛 55 | 🌐 Rust | 📅 2026-09-04 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.

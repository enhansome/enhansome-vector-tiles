...
The [Mapbox Vector Tile spec](https://github.com/mapbox/vector-tile-spec) ⭐ 1,006 | 🐛 46 | 📅 2026-06-29 is an efficient encoding for map
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,392 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-08-31 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,499 | 🐛 388 | 🌐 TypeScript | 📅 2026-08-31 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [iTowns](https://github.com/iTowns/itowns) ⭐ 1,266 | 🐛 290 | 🌐 JavaScript | 📅 2026-08-24 - Three.js based JavaScript library for visualizing 2D vector, raster and 3D geospatial data.
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 89 | 🐛 2 | 🌐 Swift | 📅 2026-08-31 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
- [esri-gl](https://github.com/muimsd/esri-gl) ⭐ 13 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - A module for using Esri services in Mapbox GL JS or MapLibre GL JS, an alternative to esri-leaflet for WebGL.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,616 | 🐛 98 | 🌐 TypeScript | 📅 2026-08-31 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,162 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 130 | 🌐 C++ | 📅 2026-08-29 - Command line tool to produce vector tiles directly from an .osm.pbf extract without an intermediate database.
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,589 | 🐛 165 | 🌐 C++ | 📅 2026-08-31 - Build vector tilesets from large collections of GeoJSON features.
...
* [gl-draw](https://github.com/mapbox/gl-draw) ⭐ 1,083 | 🐛 245 | 🌐 JavaScript | 📅 2026-08-31 - Adds support for drawing and editing features on Mapbox GL JS maps
* [map-gl-offline](https://github.com/muimsd/map-gl-offline) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26 - A TypeScript package for MapLibre GL JS and Mapbox GL JS to enable offline tiles.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,884 | 🐛 64 | 🌐 Rust | 📅 2026-08-31 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
* [tileserver-gl](https://github.com/maptiler/tileserver-gl) ⭐ 2,893 | 🐛 269 | 🌐 JavaScript | 📅 2026-08-31 Vector and raster maps with GL styles. Server side rendering by Mapbox GL Native. Map tile server for Mapbox GL JS, Android, iOS, Leaflet, OpenLayers, GIS via WMTS, etc.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,503 | 🐛 181 | 🌐 Go | 📅 2026-08-20 - is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [LOD](https://github.com/tile-fund/lod) ⭐ 24 | 🐛 12 | 🌐 Go | 📅 2026-08-31 - A thin map tile proxy with in-memory caching and a slim authentication backend.
...
* [Vector tiles remixed](http://gdunlop.github.io/Vector-tiles-remixed/) - guide to using [tilemaker](https://github.com/systemed/tilemaker) ⭐ 1,888 | 🐛 130 | 🌐 C++ | 📅 2026-08-29 to generating vector tiles

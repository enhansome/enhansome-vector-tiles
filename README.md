...
* [node-mapnik](https://github.com/mapnik/node-mapnik) ⭐ 546 | 🐛 104 | 🌐 C++ | 📅 2026-09-24 - Node.js API for vector tiles which depends on `mapnik-vector-tile`
...
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,419 | 🐛 1,454 | 🌐 TypeScript | 📅 2026-09-24 - JavaScript/WebGL vector maps library.
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,738 | 🐛 292 | 🌐 TypeScript | 📅 2026-09-24 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
- [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,241 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 - A Vector Tile to Braille and ASCII renderer for xterm-compatible terminals
...
- [ImmersiveMap](https://github.com/artembobkin/ImmersiveMap) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2026-09-24 - A Metal-rendered Mapbox Vector Tile map engine for SwiftUI with a 3D globe and flat map, for iOS and macOS.
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,641 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-22 - A visual style editor for the Mapbox GL style specification.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,189 | 🐛 112 | 🌐 Java | 📅 2026-09-23 - Command-line Java program to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [tippecanoe](https://github.com/felt/tippecanoe) ⭐ 1,608 | 🐛 166 | 🌐 C++ | 📅 2026-09-23 - Build vector tilesets from large collections of GeoJSON features.
...
* [martin](https://github.com/maplibre/martin) ⭐ 3,941 | 🐛 38 | 🌐 Rust | 📅 2026-09-24 - Blazing fast and lightweight PostGIS, MBtiles and PMtiles tile server written in Rust. Support for tile copying, diffing and updating.
